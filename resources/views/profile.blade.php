                ...
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <strong>Name: </strong><span>{{ $author->name }}</span><br>
                            <strong>About: </strong><span>{{ !empty($author->about) ? $author->about : 'NULL' }}</span><br>
                            <strong>Author Since: <span style="text-decoration: solid;"> {{ !empty($author->created_at) ? $author->created_at->toDateString() : ''  }} </span></strong><br>
                            <strong style="color: blue;">Total Posts : {{ $author->posts()->approved()->published()->count() }}</strong>
                        </div>
