...
@section('content')
    <div class="main-slider">
        <div class="swiper-container position-static" data-slide-effect="slide" data-autoheight="false"
             data-swiper-speed="1000" data-swiper-autoplay="1000" data-swiper-margin="0" data-swiper-slides-per-view="4"
                            ...
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        <li>
                                            @guest
                                                <a href="javascript:void(0)" onclick="toastr.info('To add favorite you need to login first','Info', { 
                                                        closeButton: true, 
                                                        progressBar: true,
                                                    })">
